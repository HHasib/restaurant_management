...
btnclear=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,16,'bold'),width=10, text="Reset", bg="green",cursor="hand2",command=Clear)
btnclear.grid(row=3, column=5)

btnstore=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,16,'bold'),width=10, text="Next", bg="powder blue",command=Store_data)
...
lblBurger_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text="Burger",fg="steel blue",bd=10,anchor='w',width=10)
lblBurger_cost.grid(row=1,column=1)
lblBurger_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text=costofburger,fg="steel blue",bd=10,anchor='e')
lblBurger_cost.grid(row=1,column=2)

lblPizza_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text="Pizza",fg="steel blue",bd=10,anchor='w',width=10)
lblPizza_cost.grid(row=2,column=1)
lblPizza_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text=costofpizza,fg="steel blue",bd=10,anchor='e')
lblPizza_cost.grid(row=2,column=2)

lblSumi_cost= Label(f2, font=( 'aria' ,16, 'bold' ),text="Sumi",fg="steel blue",bd=10,anchor='w',width=10)
lblSumi_cost.grid(row=3,column=1)
lblSumi_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text=costofsumi,fg="steel blue",bd=10,anchor='e')
lblSumi_cost.grid(row=3,column=2)

lblDoughnut_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text="Doughnut",fg="steel blue",bd=10,anchor='w',width=10)
lblDoughnut_cost.grid(row=4,column=1)
lblDoughnut_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text=costofdoughnut,fg="steel blue",bd=10,anchor='e')
lblDoughnut_cost.grid(row=4,column=2)

lblSet_menu_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text="Set menu",fg="steel blue",bd=10,anchor='w',width=10)
lblSet_menu_cost.grid(row=5,column=1)
lblSet_menu_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text=costofset,fg="steel blue",bd=10,anchor='e')
lblSet_menu_cost.grid(row=5,column=2)

lblSub_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text="Sub",fg="steel blue",bd=10,anchor='w',width=10)
lblSub_cost.grid(row=6,column=1)
lblSub_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text=costofsub,fg="steel blue",bd=10,anchor='e')
lblSub_cost.grid(row=6,column=2)

lblChicken_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text="Chicken",fg="steel blue",bd=10,anchor='w',width=10)
lblChicken_cost.grid(row=7,column=1)
lblChicken_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text=costofchick,fg="steel blue",bd=10,anchor='e')
lblChicken_cost.grid(row=7,column=2)

lblFuchka_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text="Fuchka",fg="steel blue",bd=10,anchor='w',width=10)
lblFuchka_cost.grid(row=8,column=1)
lblFuchka_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text=costoffuchka,fg="steel blue",bd=10,anchor='e')
lblFuchka_cost.grid(row=8,column=2)

lblCold_coffee_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text="Cold coffee",fg="steel blue",bd=10,anchor='w',width=10)
lblCold_coffee_cost.grid(row=9,column=1)
lblCold_coffee_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text=costofcoffee,fg="steel blue",bd=10,anchor='e')
lblCold_coffee_cost.grid(row=9,column=2)

lblDrink_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text="Drinks",fg="steel blue",bd=10,anchor='w',width=10)
lblDrink_cost.grid(row=10,column=1)
lblDrink_cost = Label(f2, font=( 'aria' ,16, 'bold' ),text=costofdrink,fg="steel blue",bd=10,anchor='e')
...
txtPaid = Entry(f2,font=('ariel' ,16,'bold'), textvariable=Paid , bd=6,insertwidth=4,bg="powder blue" ,cursor = "xterm", justify='right')
...
btnReturn=Button(f2,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,16,'bold'),width=10, text="Next", bg="powder blue",command=Return_money)
