...
btnCold_coffee=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,16,'bold'),width=10, text="Cold_coffee", bg="powder blue",command= Cold_coffee_add)
...
lblBurger = Label(f2, font=( 'aria' ,16, 'bold' ),text=Burger*250,fg="steel blue",bd=10,anchor='e')
...
lblPizza = Label(f2, font=( 'aria' ,16, 'bold' ),text=Pizza*100,fg="steel blue",bd=10,anchor='e')
...
lblSet_menu = Label(f2, font=( 'aria' ,16, 'bold' ),text="Set_menu",fg="steel blue",bd=10,anchor='w',width=10)
...
lblCold_coffee = Label(f2, font=( 'aria' ,16, 'bold' ),text="Cold_coffee",fg="steel blue",bd=10,anchor='w',width=10)
...
lblBurger = Label(f2, font=( 'aria' ,16, 'bold' ),text="Burger",fg="steel blue",bd=10,anchor='w',width=10)
lblBurger.grid(row=1,column=1)
lblBurger = Label(f2, font=( 'aria' ,16, 'bold' ),text=250*Burger,fg="steel blue",bd=10,anchor='e')
lblBurger.grid(row=1,column=2)
