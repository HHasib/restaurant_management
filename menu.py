...
lblBurger = Label(f2, font=( 'aria' ,16, 'bold' ),text=costofburger,fg="steel blue",bd=10,anchor='e')
...
lblPizza = Label(f2, font=( 'aria' ,16, 'bold' ),text=costofpizza,fg="steel blue",bd=10,anchor='e')
